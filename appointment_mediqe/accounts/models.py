...
class User(AbstractBaseUser):
    ...
    last_name = models.CharField(
        max_length=150, null=True, blank=True, verbose_name="last name"
    )
    ...
    is_verified = models.BooleanField(
        default=False, verbose_name="is user verified or not"
    )
    ...
    extra_info = models.JSONField(
        null=True, blank=True, verbose_name="extra fields and data"
    )
...
class UserProfile(models.Model):
    ...
    )  # connected as multiple to one filed to user model
    insurance_number = models.CharField(
        null=True, blank=True, max_length=200, verbose_name="Insurance Number"
    )
    insurance_company = models.CharField(
        null=True, blank=True, max_length=50, verbose_name="insurance company"
    )
    ...
    chronic_conditions = models.TextField(
        null=True, blank=True, verbose_name="chronic conditions"
    )
    license_number = models.CharField(
        max_length=80, null=True, blank=True, verbose_name="license number"
    )
    speciality = models.CharField(
        max_length=100, null=True, blank=True, verbose_name="Speciality"
    )
    bio = models.TextField(null=True, blank=True, verbose_name="biogeraphy")
    years_of_experiences = models.IntegerField(
        null=True, blank=True, verbose_name="yeasr of experiences"
    )

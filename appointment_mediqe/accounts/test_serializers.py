...
class UserSerializerTests(TestCase):
    ...
    def test_update_user_updates_password(self):
        ...
        update_data = {
            'email': USER_DATA['email'],  # Email required for validation, though not changing
...
class UserProfileSerializerTests(TestCase):
    ...
    def test_nested_update_both_user_and_profile(self):
        ...
        serializer = UserProfileSerializer(instance=profile, data=update_data, partial=True)
        self.assertTrue(serializer.is_valid(), serializer.errors)

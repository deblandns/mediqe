...
from accounts.permissions import user_is_admin, user_has_role
from accounts.models import User

class PermissionTest(TestCase):
    def setUp(self):
        self.admin = User.objects.create(phone='09123456789', role='Admin')
        self.doctor = User.objects.create(phone='09123456788', role='Doctor')
        self.patient = User.objects.create(phone='09123456787', role='Patient')
    
    def test_user_is_admin(self):
        self.assertTrue(user_is_admin(self.admin))
        self.assertFalse(user_is_admin(self.doctor))
        self.assertFalse(user_is_admin(self.patient))
    
    def test_user_has_role(self):
        self.assertTrue(user_has_role(self.doctor, ['Admin', 'Doctor']))
        self.assertFalse(user_has_role(self.patient, ['Admin', 'Doctor']))
```
